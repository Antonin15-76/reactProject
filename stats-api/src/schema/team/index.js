...
export const Team = objectType({
  ...
  definition (t) {
    ...
    t.date('end', { nullable: false, resolve: resolvers.endResolve })
    t.list.field('drivers', { type: Driver, resolve: resolvers.driversResolve })
    ...
    t.list.date('yearsTitlePilote', { nullable: false, resolve: resolvers.yearsTitlePiloteResolve })
    t.list.date('yearsTitleConstructor', { nullable: false, resolve: resolvers.yearsTitleConstructorResolve })
...
export const CreateTeamInput = inputObjectType({
  ...
  definition (t) {
    ...
    t.date('end', { nullable: false })
    t.list.field('drivers', { type: DriverInput, nullable: false })
    ...
    t.list.date('yearsTitlePilote', { nullable: false })
    t.list.date('yearsTitleConstructor', { nullable: false })
