...
import Chart from "../Components/ComponentsCharts/Chart"
import Highcharts from 'highcharts/highstock'
import StockChart from "../Components/ComponentsCharts/Stock"
import { pivotpoints } from 'highcharts/indicators/pivot-points'
import { macd } from 'highcharts/indicators/macd'
import BarChart from "../Components/ComponentsCharts/BarChart"
...
const stockOptions = {
    ...
    series: [{
      data: [
        ...
        // [1507852800000,156.73,157.28,156.41,156.99]
            [2000000000000, 153, 154, 155, 156],
            [2000000500000, 153, 154, 156, 158, 159]
      ],
      type: 'ohlc',
  ...
  const barOptions = {
    ...
    series: [{
        name: 'Girard',
        data: [1, 3, 2, 1, 5, 8,  2, 1, 5, 14]
    }, {
        name: 'Leclerc',
        data: [2, 12, 3, 2, 14, 2, 12, 3, 2, 14]
    }, {
        name: 'Bottas',
        data: [4, 1, 4, 3, 2, 4, 1, 4, 3, 2]
    }, {
        name: 'Vettel',
        data: [3, 14, 1, 6, 3, 3, 14, 1, 6, 3]
    }, {
        name: 'Sainz',
        data: [6, 6, 15, 4, 1, 6, 6, 15, 4, 1]
    }, {
        name: 'Perez',
        data: [15, 5, 16, 5, 6, 15, 5, 16, 18, 6]
    }],
    type: 'bar'
  }
    ...
    return (
        ...
        >
            ...
            <Grid container spacing={3} style={{ padding: '20px' }}>
                ...
                <Grid item xs={12}>
                    <BarChart options={barOptions} highcharts={Highcharts} />
                </Grid>
                <Grid item xs={4}>
